const CACHE = 'black-moon-demo-v4';
const ASSETS = ['./','./index.html','./styles.css','./game.js','./manifest.webmanifest','./assets/icon.svg','./assets/portraits/black-cat.svg','./assets/portraits/crow.svg','./assets/portraits/fox.svg','./assets/portraits/rabbit.svg','./assets/portraits/full/shadow.png','./assets/portraits/full/fang.png','./assets/portraits/full/tail.png','./assets/portraits/full/snow.png','./assets/references/tavern-style.png','./assets/references/main-menu.png','./assets/references/character-select.png','./assets/references/battle-screen.png'];
