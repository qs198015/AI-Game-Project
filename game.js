(() => {
  ...
  let state, toastTimer, audio, storyIndex=0, save=loadSave(), selectedPlayer=save.selected;
  const STORY=[
    {speaker:'鸦策',role:'黑月酒馆老板',portrait:'crow',text:'欢迎来到旧钟街最后一间还收谎话的酒馆。今晚的规矩很简单：别先眨眼。'},
