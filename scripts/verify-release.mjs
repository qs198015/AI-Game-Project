...
const required=['index.html','styles.css','game.js','manifest.webmanifest','sw.js','assets/icon.svg','assets/intro/opening.mp4','assets/portraits/black-cat.svg','assets/portraits/crow.svg','assets/portraits/fox.svg','assets/portraits/rabbit.svg'];
...
const bytes=required.filter(file=>file!=='assets/intro/opening.mp4').reduce((sum,file)=>sum+fs.statSync(path.join(root,file)).size,0);
