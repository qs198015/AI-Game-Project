...
const required=['index.html','styles.css','game.js','manifest.webmanifest','sw.js','assets/icon.svg','assets/main-menu/main-menu-v3.png','assets/battle/backgrounds/wolf_crest_tavern_table.png','assets/characters/portraits/player_blackcat.png','assets/menu-buttons/button-start-game.png','assets/menu-buttons/button-tutorial.png','assets/menu-buttons/button-story-mode.png','assets/menu-buttons/button-black-moon-trial.png','assets/menu-buttons/button-pet-gallery.png','assets/menu-buttons/button-settings.png','assets/intro/opening.mp4','assets/portraits/black-cat.svg','assets/portraits/crow.svg','assets/portraits/fox.svg','assets/portraits/rabbit.svg'];
